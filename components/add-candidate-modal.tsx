...
export default function AddCandidateModal({ open, onOpenChange, onSubmit }: AddCandidateModalProps) {
  // Available options
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>Fill in the details to add a new candidate to the system.</DialogDescription>
        </DialogHeader>
